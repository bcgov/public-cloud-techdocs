...
1. Navigate to the top menu called **Public cloud Products**.

  ![public-cloud](../images/provision-a-project-set/public-cloud.png)

1. On the top right side of the screen click on the **Create +** button to create a Project Set.

  ![create](../images/provision-a-project-set/create.png)

1. Enter the **name** and **description** of your project.
...
1. Enter your **ministry** and desired **service provider**.

  ![ministry-provider](../images/provision-a-project-set/ministry-provider.png)

1. Enter the **Product Owner** and **Technical Lead(s)** details per each required field.
...
1. Enter your **estimated budgets**.
