...
!!! question "Do I really need Microsoft Fabric?"
    Before you request a project set in the Azure Landing Zone, contact the [DataFoundations team](mailto:NRM.DataFoundations@gov.bc.ca), or complete the [Fabric and Data Analytics Platform (DAP) support form](https://apps.nrs.gov.bc.ca/int/jira/servicedesk/customer/portal/1/create/1701). They can confirm whether Microsoft Fabric is the best fit for your project.
