...
To fix this, use a User Defined Route (UDR). The UDR ensures that the return/response path uses the internet instead of ExpressRoute. Submit a [support request](https://citz-do.atlassian.net/servicedesk/customer/portal/3) to the Public Cloud team to create the UDR.
