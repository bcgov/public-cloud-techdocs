...
AWS DirectConnect provides a private connection between an organization’s on-premises infrastructure and AWS data centres. Because this connection does not travel over the public internet, it offers stronger security, reliability and performance.

In our setup, DirectConnect also encrypts data in transit with IPsec. This ensures data stays secure while moving between AWS and on-premises networks.
