...
!!! info "About AWS LZA"
    ...
    AWS Landing Zone Accelerator (LZA) is the current solution for secure, compliant AWS cloud environments in the B.C. government. It provides a standardized, well-architected foundation for building and deploying applications in AWS with built-in security guardrails and compliance controls.
