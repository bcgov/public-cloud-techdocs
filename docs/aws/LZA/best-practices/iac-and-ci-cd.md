...
- **VPC and subnet management**: VPCs and subnets are managed by the platform and cannot be created or modified by users. Security groups are the exception and can be managed by users
...
Apply consistent tags to all resources for cost allocation and management:
...
Security groups are one of the few networking components you can manage. Follow the principle of least privilege:
