...
You cannot change, delete, or in some cases even interact with these protected resources, such as certain CloudFormation stacks, IAM roles, S3 buckets, and network components.
...
* You cannot change the encryption settings of existing PBMM-tagged storage resources
...
* You cannot create new VPCs or modify existing ones that are part of the protected infrastructure. Plan your resource deployments within the existing network structure
...
1. Encryption:
   ...
   * When creating new S3 buckets, EBS volumes, or RDS instances, you must ensure they are encrypted. The system will enforce this, but be aware that you cannot create unencrypted storage resources
...
3. Logging and monitoring:
   ...
   * You can create your own CloudWatch alarms and dashboards, but you cannot modify ones that are part of the protected infrastructure
...
* You cannot create new IAM users or groups. If you need to onboard new team members or create new roles, you can do that using the [Product Registry](https://registry.developer.gov.bc.ca). See [B.C. government Product Registry - user management documentation](../design-build-and-deploy-an-application/user-management.md) for more information
...
You do not have direct access to billing information or the ability to set up detailed cost allocation tags. However, you can view your total spend and associated costs using AWS Cost Explorer.
